...
description: Create and deploy a React Router app to AWS with SST.
---

We are going to create a React Router app, add an S3 Bucket for file uploads, and deploy it to using the `React` component.
